...
<div id="divMain">
  ...
  <div class="SubMenu">
 	<a href="https://player.lmih.cn" title="访问播放器专用后台编辑歌单" target="_blank"><span class="m-left" style="color:#f00">歌单管理面板</span></a>
  </div>
  <div id="divMain2">
<!--代码-->
    <?php
	...
	if(isset($_POST['id'])){
		$zbp->Config('MyhkPlayer')->xl = $_POST['xl'];
...
<tr>
    ...
    <td><span class="sel"><select name="xl"><option value="player" <?php if($zbp->Config('MyhkPlayer')->xl=="player") echo "selected"; ?>>主站</option><option value="music" <?php if($zbp->Config('MyhkPlayer')->xl=="music") echo "selected"; ?>>一线</option></option><option value="home" <?php if($zbp->Config('MyhkPlayer')->xl=="home") echo "selected"; ?>>二线</option></select></span></td>
</tr>
<tr>
...
<tr>
	...
	<td><b><a href="https://player.lmih.cn" target="_blank">https://player.lmih.cn</b></a></td>
</tr>
