...
$blogtitle=$zbp->LoadApp('plugin','ggravatar')->name.' Ver '.$zbp->LoadApp('plugin','ggravatar')->version.' @ '.$zbp->LoadApp('plugin', 'ggravatar')->modified;
...
if (count($_POST) > 0) {
	...
	$zbp->Config('ggravatar')->qq = GetVars('qq','post');
...
<td>
	...
	<p><b>官方cn</b>：<a href="javascript:void(0)" class="enterGravatar">https://cn.gravatar.com/avatar/</a></p>
	<p><b>官方加密</b>：<a href="javascript:void(0)" class="enterGravatar">https://secure.gravatar.com/avatar/</a></p>
	<p><b>极客族</b>：<a href="javascript:void(0)" class="enterGravatar">https://sdn.geekzu.org/avatar/</a></p>
	<p><b>七牛</b>：<a href="javascript:void(0)" class="enterGravatar">https://dn-qiniu-avatar.qbox.me/avatar/</a></p>
</td>
</tr>
...
<tr>
<td><p align='left'><b>·优先本地头像</b><br/><span class='note'></span></p></td>
...
<td><p>注册会员优先查找本地头像,优先级高于QQ头像</p></td>
</tr>
<tr>
<td><p align='left'><b>·优先QQ头像</b><br/><span class='note'></span></p></td>
<td><p><input id='qq' name='qq' class="checkbox" type='text' value='<?php echo $zbp->Config('ggravatar')->qq ?>' /></p></td>
<td><p>qq邮箱优先使用QQ头像</p></td>
</tr>
<tr>
<td><p align='left'><b>·判断Gravatar初始头像</b><br/><span class='note'></span></p></td>
