...
console.log('Neditor: 当前以兼容模式运行，此模式极不稳定，请确认需求后启用。');
...
window.onload = () => {
  ...
  $(() => {
    ...
    if (window.NEDITOR.phpAlert) {
      phpAlertHtml = '<p style="color:red">【重要提示】<br>您的 PHP 版本过低，Neditor 未来的更新将不再支持 PHP 5.6 以下的版本，请及时升级 PHP，强烈建议使用 PHP 7.2 及以上版本！</p><br>';
    }
    let updateLog = '';
